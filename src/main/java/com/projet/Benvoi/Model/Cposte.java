...
public class Cposte {
	...
	/*	public int getNumreg() {
		...
		public Cposte(long id, int annee, int code_dir
				, /*int numblf, int numcommf, int numavf, int numbon, int numbs,
				int numbr, int numfacf, int numinv, int numpre, int numpro, int numcsonede, int numcsteg,
				int numccarburant,*/ int numcollecte, int numdepot, //int numreg, int numfact, 
				int numenvoi) {
			super();
			this.id = id;
			this.annee = annee;
		...
		public String toString() {
			return "Cposte [id=" + id + ", annee=" + annee + ", code_dir=" + code_dir + numcollecte + ", numdepot=" + numdepot
					+  ", numenvoi=" + numenvoi + "]";
		}
